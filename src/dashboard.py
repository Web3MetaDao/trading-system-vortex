...
def load_live_positions() -> pd.DataFrame:
    ...
    return pd.DataFrame([
        {"Symbol": "BTCUSDT", "Side": "LONG", "Entry": 75800.0, "Current": 76100.0, "PnL%": 0.4, "Size": 500.0},
        {"Symbol": "ETHUSDT", "Side": "SHORT", "Entry": 2400.0, "Current": 2390.0, "PnL%": 0.42, "Size": 300.0}
    ])
...
fig = go.Figure()
fig.add_trace(go.Scatter(x=equity_df['Date'], y=equity_df['Equity'], mode='lines+markers', name='Equity'))
fig.update_layout(xaxis_title="Date", yaxis_title="Equity (USDT)")
st.plotly_chart(fig, use_container_width=True)

st.subheader("📁 System Logs")
st.code("INFO: [BTCUSDT] Signal A+ detected. ML Confidence: 0.89\nINFO: [BTCUSDT] Risk Approved. Size: 150.0 USDT\nINFO: [ETHUSDT] Position closed via ATR Trailing Stop. PnL: +12.5 USDT", language="log")

# Sidebar - Symbol Config
st.sidebar.subheader("Active Symbols")
st.sidebar.multiselect("Monitoring", ["BTCUSDT", "ETHUSDT", "BNBUSDT", "SOLUSDT"], default=["BTCUSDT", "ETHUSDT"])
